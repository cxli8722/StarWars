...
$(document).ready(function() {
  ...
  // This function will dynamatically render character to page
  ...
  var renderCharacter = function(character, renderArea) {
   ...
   // <img alt='image' class='character-image' src="character image url">
    var charImage = $("<img alt='image' class='character-image'>").attr("src", character.imageUrl);
    // <div class='character-health'> character.health</div>
...
// </div>
  ...
  var initializeGame = function() {
    ...
    for (var key in characters) {
      renderCharacter(characters[key], "#characters-section");// #characters-section is on the index.html section on teh index.html 
    }
  };
  ...
  $("#attack-button").on("click", function() {
    ...
    if ($("#defender").children().length !== 0) {
      ...
      clearMessage();
      renderMessage("please select your enemy");
    }
  });
});
